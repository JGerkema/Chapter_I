...
# try_clean2 contains 69191 unique, "accepted" species names
...
check_na <- try_traits_tax_final %>%
  select(c(wfo_match, ObservationID, genus, family, order, TraitName, StdValue)) %>%
