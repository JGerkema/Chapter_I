...
load("~/0. PhD/0. Chapter_I/data/processed/try_clean106.RData")
...
godver <- try_traits_tax_final %>%
  filter(Reference == "Purcell, A. S. T., W. G. Lee, A. J. Tanentzap, and D. C. Laughlin. 2019. Fine root traits are correlated with flooding duration while aboveground traits are related to grazing in an ephemeral wetland. Wetlands 39(2): 291-302.")

write.table(ref_save, file = "docs/ref_save.txt",  row.names = TRUE)
write_xlsx(ref_save, path = "docs/ref_save.xlsx")
write_xlsx(ref, path = "docs/ref106_.xlsx")
